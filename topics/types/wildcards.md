...
* [X] _the signature_ of a method which takes an `Either` instance, and whose implementation returns the "left" value if it exists, or throws a `NoSuchElementException`
